...
<?php
    ...
    if(isset($_GET['add'])){
        ...
        if($errorTitle == "" && $errorStartDate == "" && $errorEndDate == "" && $errorStartTime == "" && $errorEndTime == "" && $errorLocation == "" && $errorDetail == ""){
            ...
            $result = mysqli_query($link, "INSERT INTO request_calendar(title, detail, start_date, end_date, start_time, end_time, location, date_added) VALUES ('" . $title . "','" . $detail . "','" . $startdate . "','" . $end_date . "','" . $startTime . "','" . $endTime . "','" . $location . "', NOW())");

            //echo "INSERT INTO request_calendar(title, detail, event_date, start_date, end_date, start_time, end_time, location, date_added) VALUES ('" . $title . "','" . $detail . "','" . $startdate . "','" . $endDate . "','" . $startTime . "','" . $endTime . "','" . $location . "', NOW())";
            //echo "INSERT INTO request_calendar(title, detail, event_date, date_added) VALUES ('" . $title . "','" . $detail . "','" . $eventdate . "', 'NOW()')";
        ...
        //echo "DELETE FROM `request_calendar` WHERE event_date = " . $eventdate;
        //echo $eventdate;
        ...
        if($errorTitle == "" && $errorStartDate == "" && $errorEndDate == "" && $errorStartTime == "" && $errorEndTime == "" && $errorLocation == "" && $errorDetail == ""){
            ...
            //echo "UPDATE request_calendar SET title = '" . $title . "', detail = '" . $detail . "' WHERE event_date = '" . $eventdate . "'"; 
...
?>
    ...
    FROM
        ...
        JOIN `azs_testing`.`approved` `a` ON ((`r`.`request_id` = `a`.`request_id`))) WHERE `r`.`status` = 'Reviewed'";
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    if($dateInDB == $first_date || $dateInDB == $second_date || $dateInDB == $third_date || $dateInDB == $fourth_date){
                        echo "<br/>";
    ...
    <?php
        if(isset($_GET['v'])){ 
            ...
            $eventQuery = "SELECT * FROM request_calendar";
