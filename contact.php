...
if(isset($_POST["submitContact"])){
    ...
    if($errorFN == "" && $errorLN == "" && $errorEmail == "" && $errorMessage == "" && $errorSubject == ""){
        ...
        echo "<h2 class='headerPages'>Your email was sent successfully.</h2>"; 
        die();
...
?>
            ...
            <div class="contact_info">  <!-- Contact Info -->
                ...
                <hr/>
                <address>
                    <strong>Infini Portal Team</strong><br>
                    <a href="mailto:portal@convorelay.com">chris@theinfini.com</a>
                </address>
            </div>  <!-- Contact Info // -->
<?php
